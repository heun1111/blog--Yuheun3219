        ...
        <div className="col-span-12 lg:col-span-8 lg:col-start-5 space-y-24">
          <section className="space-y-8">
            ...
            <p className="text-2xl leading-relaxed text-on-surface-variant">
              Tailwind v4 is a significant evolution for the utility-first framework. By moving to a Rust-based engine, build times are virtually eliminated even in massive projects. The shift toward a 'zero-config by default' approach makes it easier than ever to implement complex design systems while keeping the bundle size microscopic and the development flow uninterrupted.
            </p>
            <p className="text-2xl leading-relaxed text-on-surface-variant">
          ...
          <div className="bg-primary text-white rounded-xl p-16 text-center space-y-10 shadow-2xl shadow-primary/30">
            ...
            <p className="text-xl opacity-90 max-w-2xl mx-auto leading-relaxed">Download our detailed guide on Tailwind CSS v4: The Engine Shift.</p>
