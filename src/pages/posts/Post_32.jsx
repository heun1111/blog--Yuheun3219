        ...
        <div className="col-span-12 lg:col-span-8 lg:col-start-5 space-y-24">
          <section className="space-y-8">
            ...
            <p className="text-2xl leading-relaxed text-on-surface-variant">
              CSS Grid is the ultimate tool for structured layout. When building high-density dashboards, the ability to define two-dimensional placement is indispensable. Combined with container queries, we can build grids that aren't just responsive to the screen, but also to their own space, creating an 'ethereal' flow where every element feels perfectly positioned regardless of the device.
            </p>
            <p className="text-2xl leading-relaxed text-on-surface-variant">
          ...
          <div className="bg-primary text-white rounded-xl p-16 text-center space-y-10 shadow-2xl shadow-primary/30">
            ...
            <p className="text-xl opacity-90 max-w-2xl mx-auto leading-relaxed">Download our detailed guide on CSS Grid for High-Density Layouts.</p>
