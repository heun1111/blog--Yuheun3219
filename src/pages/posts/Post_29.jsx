        ...
        <div className="col-span-12 lg:col-span-8 lg:col-start-5 space-y-24">
          <section className="space-y-8">
            ...
            <p className="text-2xl leading-relaxed text-on-surface-variant">
              CI/CD shouldn't be a copy-paste affair. By leveraging reusable workflows in GitHub Actions, organizations can standardize their testing and deployment logic. This leads to cleaner repositories and faster project kick-offs, as new services can tap into a pre-vetted ethereal infrastructure pipeline that handles everything from linting to containerized production deployment.
            </p>
            <p className="text-2xl leading-relaxed text-on-surface-variant">
          ...
          <div className="bg-primary text-white rounded-xl p-16 text-center space-y-10 shadow-2xl shadow-primary/30">
            ...
            <p className="text-xl opacity-90 max-w-2xl mx-auto leading-relaxed">Download our detailed guide on Modular CI/CD with GitHub Actions.</p>
