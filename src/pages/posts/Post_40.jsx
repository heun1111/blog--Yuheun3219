        ...
        <div className="col-span-12 lg:col-span-8 lg:col-start-5 space-y-24">
          <section className="space-y-8">
            ...
            <p className="text-2xl leading-relaxed text-on-surface-variant">
              Observability is about more than just logs. OpenTelemetry provides a unified standard for traces, metrics, and logs across any language or cloud. By instrumenting our ethereal software with Otel, we gain a deep, high-fidelity view of how data flows through our services, allowing us to find and fix performance bottlenecks before they ever impact the end user.
            </p>
            <p className="text-2xl leading-relaxed text-on-surface-variant">
          ...
          <div className="bg-primary text-white rounded-xl p-16 text-center space-y-10 shadow-2xl shadow-primary/30">
            ...
            <p className="text-xl opacity-90 max-w-2xl mx-auto leading-relaxed">Download our detailed guide on Observability with OpenTelemetry.</p>
