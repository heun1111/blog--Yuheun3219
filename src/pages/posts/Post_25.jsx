        ...
        <div className="col-span-12 lg:col-span-8 lg:col-start-5 space-y-24">
          <section className="space-y-8">
            ...
            <p className="text-2xl leading-relaxed text-on-surface-variant">
              Implementing dark mode is more than just inverting colors. We must balance brand recognition with visual comfort, ensuring that contrast ratios remain accessible. By using semantic tokens and ambient occlusion, we can create dark themes that feel as airy and editorial as their light counterparts, providing a seamless transition for the user across different lighting conditions.
            </p>
            <p className="text-2xl leading-relaxed text-on-surface-variant">
          ...
          <div className="bg-primary text-white rounded-xl p-16 text-center space-y-10 shadow-2xl shadow-primary/30">
            ...
            <p className="text-xl opacity-90 max-w-2xl mx-auto leading-relaxed">Download our detailed guide on Dark Mode UX: Consistency & Contrast.</p>
