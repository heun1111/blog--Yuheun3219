        ...
        <div className="col-span-12 lg:col-span-8 lg:col-start-5 space-y-24">
          <section className="space-y-8">
            ...
            <p className="text-2xl leading-relaxed text-on-surface-variant">
              Micro-frontends bring the benefits of microservices to the frontend world. By decoupling the architecture into small, independent apps that live on a single shell, large organizations can scale their engineering teams without the bottleneck of a single deployment pipeline. It's about autonomy, speed, and maintaining a cohesive user experience across fragmented services.
            </p>
            <p className="text-2xl leading-relaxed text-on-surface-variant">
          ...
          <div className="bg-primary text-white rounded-xl p-16 text-center space-y-10 shadow-2xl shadow-primary/30">
            ...
            <p className="text-xl opacity-90 max-w-2xl mx-auto leading-relaxed">Download our detailed guide on Scaling Frontends with Micro-Architecture.</p>
