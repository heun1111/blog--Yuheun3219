        ...
        <div className="col-span-12 lg:col-span-8 lg:col-start-5 space-y-24">
          <section className="space-y-8">
            ...
            <p className="text-2xl leading-relaxed text-on-surface-variant">
              Interaction to Next Paint (INP) is replacing First Input Delay as the core interactivity metric. It measures the latency of all interactions across the entire lifecycle of a page. To master this, we must optimize our JavaScript event handlers and ensure the main thread remains free for UI updates. It's about ensuring every touch and click feels ethereal and instantaneous.
            </p>
            <p className="text-2xl leading-relaxed text-on-surface-variant">
              This technical deep dive explores the nuances of performance and how it integrates with modern software lifecycles. 
          ...
          <div className="bg-primary text-white rounded-xl p-16 text-center space-y-10 shadow-2xl shadow-primary/30">
            ...
            <p className="text-xl opacity-90 max-w-2xl mx-auto leading-relaxed">Download our detailed guide on INP: The Next Generation of Speed.</p>
