        ...
        <div className="col-span-12 lg:col-span-8 lg:col-start-5 space-y-24">
          <section className="space-y-8">
            ...
            <p className="text-2xl leading-relaxed text-on-surface-variant">
              The 'local-first' movement is revolutionizing how we think about data. By using SQLite compiled to WebAssembly, apps can have a true, multi-functional database living directly on the user's device. This enables instantaneous interactions and full offline support, with data syncing in the background to provide a resilient, ethereal experience that never leaves the user waiting.
            </p>
            <p className="text-2xl leading-relaxed text-on-surface-variant">
          ...
          <div className="bg-primary text-white rounded-xl p-16 text-center space-y-10 shadow-2xl shadow-primary/30">
            ...
            <p className="text-xl opacity-90 max-w-2xl mx-auto leading-relaxed">Download our detailed guide on Local-First: SQLite in the Browser.</p>
