        ...
        <div className="col-span-12 lg:col-span-8 lg:col-start-5 space-y-24">
          <section className="space-y-8">
            ...
            <p className="text-2xl leading-relaxed text-on-surface-variant">
              Databases are the final layer of the stack to go serverless. Platforms like Neon and PlanetScale are proving that we can have the reliability of Postgres and MySQL with the scalability of the cloud. Features like storage/compute separation and native connection pooling allow modern apps to scale from hobbyist levels to enterprise demand without manual intervention.
            </p>
            <p className="text-2xl leading-relaxed text-on-surface-variant">
          ...
          <div className="bg-primary text-white rounded-xl p-16 text-center space-y-10 shadow-2xl shadow-primary/30">
            ...
            <p className="text-xl opacity-90 max-w-2xl mx-auto leading-relaxed">Download our detailed guide on The Era of Serverless Postgres.</p>
