        ...
        <div className="col-span-12 lg:col-span-8 lg:col-start-5 space-y-24">
          <section className="space-y-8">
            ...
            <p className="text-2xl leading-relaxed text-on-surface-variant">
              The SOLID principles aren't just for Java developers. In the world of modern JavaScript and React, single responsibility and dependency inversion are more relevant than ever. By structuring components as focused, interchangeable units, we create codebases that are resilient to change and trivial to test, even as complexity grows over time.
            </p>
            <p className="text-2xl leading-relaxed text-on-surface-variant">
          ...
          <div className="bg-primary text-white rounded-xl p-16 text-center space-y-10 shadow-2xl shadow-primary/30">
            ...
            <p className="text-xl opacity-90 max-w-2xl mx-auto leading-relaxed">Download our detailed guide on SOLID Principles in Modern JS.</p>
